...
#
# After apply, get ARNs:
#   aws wafv2 list-ip-sets --scope REGIONAL --region us-east-1 \
#     --query "IPSets[?contains(Name,'AllowIP') || contains(Name,'BlockIP')].[Name,ARN]" \
#     --output table
#
# Then in other WAF tfvars, reference by ARN (no IPs needed):
...
# -----------------------------------------------------------------------------
# Required — backend (state stored separately from WAF deployments)
# -----------------------------------------------------------------------------
bucket = "bizx2-rapyder-jenkins-waf-2026"
key    = "waf-alb-existing/ip-list.tfstate"
region = "us-east-1"
...
# Used by: PROD-BSA-Backend and other backend WAFs
# =============================================================================
#allowlist_ips = [
#  "139.64.132.20/32",
#  "45.33.65.221/32",
...
# =============================================================================
# IP Set 3 — Keybank-Orchestrator-Prod-BlockIP  (5 IPs)
# Used by: Orchestrator WAF as blocklist
# =============================================================================
#blocklist_ips = [
#  "3.6.25.60/32",
#  "139.59.93.44/32",
...
# Used by: PROD-BSA-Frontend and other frontend WAFs
# =============================================================================
...
# =============================================================================
# All WAF rules disabled — IP set creation only
# =============================================================================
